...
std::vector<std::pair<P<T_P>, T_P>> Problem_of_Apollonius(P<T_P> Center1, T_P Radius1, P<T_P> Center2, T_P Radius2, P<T_P> Center3, T_P Radius3, int sgn1, int sgn2, int sgn3) {
    ...
    for (const auto r : quad_ret.second) if (r >= 0.0) {
