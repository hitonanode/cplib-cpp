...
data:
  ...
  bundledCode: "#line 1 \"linear_algebra_matrix/test/matrix_pow.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/pow_of_matrix\"\n#line 2 \"modint.hpp\"\
    \n#include <cassert>\n#include <iostream>\n#include <set>\n#include <vector>\n\
    ...
    \    }\n};\n#line 5 \"linear_algebra_matrix/test/matrix_pow.test.cpp\"\nusing\
    \ namespace std;\n\nint main() {\n    cin.tie(nullptr);\n    ios::sync_with_stdio(false);\n\
    \n    int N;\n    long long K;\n    cin >> N >> K;\n    matrix<ModInt<998244353>>\
    \ M(N, N);\n    cin >> M;\n    M = M.pow(K);\n    for (int i = 0; i < N; ++i)\
...
layout: document
redirect_from:
- /verify/linear_algebra_matrix/test/matrix_pow.test.cpp
- /verify/linear_algebra_matrix/test/matrix_pow.test.cpp.html
