...
data:
  ...
  bundledCode: "#line 1 \"linear_algebra_matrix/test/matrix_rank.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/matrix_rank\"\n#line 2 \"modint.hpp\"\
    \n#include <cassert>\n#include <iostream>\n#include <set>\n#include <vector>\n\
    ...
    \    }\n};\n#line 5 \"linear_algebra_matrix/test/matrix_rank.test.cpp\"\nusing\
  ...
  verifiedWith: []
documentation_of: linear_algebra_matrix/test/matrix_rank.test.cpp
layout: document
redirect_from:
- /verify/linear_algebra_matrix/test/matrix_rank.test.cpp
- /verify/linear_algebra_matrix/test/matrix_rank.test.cpp.html
