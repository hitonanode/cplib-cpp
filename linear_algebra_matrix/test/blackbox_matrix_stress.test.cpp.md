...
data:
  ...
  bundledCode: "#line 1 \"linear_algebra_matrix/test/blackbox_matrix_stress.test.cpp\"\
    ...
    \ mat(2, 2);\n    mat[0][1] = 1;\n    mat[1][0] = b;\n    mat[1][1] = a;\n   \
    \ return mat.pow(k + 1)[0][1];\n}\n#line 6 \"linear_algebra_matrix/test/blackbox_matrix_stress.test.cpp\"\
    \n#include <cstdio>\n#line 8 \"linear_algebra_matrix/test/blackbox_matrix_stress.test.cpp\"\
    \nusing namespace std;\n\nmt19937 mt(1010101);\n\ntemplate <class MODINT, class\
    \ MATRIX, typename std::enable_if<std::is_same<MATRIX, toeplitz<MODINT>>::value>::type*\
