...
* <a href="{{ site.github.repository_url }}/blob/master/formal_power_series/test/fps_log.test.cpp">View this file on GitHub</a>
...
{% raw %}
```cpp
#line 1 "formal_power_series/test/fps_log.test.cpp"
#define PROBLEM "https://judge.yosupo.jp/problem/log_of_formal_power_series"
#include <iostream>
