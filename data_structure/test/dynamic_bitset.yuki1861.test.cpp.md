...
data:
  ...
  bundledCode: "#line 1 \"data_structure/test/dynamic_bitset.yuki1861.test.cpp\"\n\
    ...
    \        }\n        return -1;\n    }\n};\n#line 3 \"data_structure/test/dynamic_bitset.yuki1861.test.cpp\"\
    \n#include <iostream>\n#line 5 \"data_structure/test/dynamic_bitset.yuki1861.test.cpp\"\
    \nusing namespace std;\n\nstd::vector<std::vector<int>> knapsack_first_fit(const\
    \ std::vector<int> &A, int K) {\n    dynamic_bitset bs(K + 1);\n\n    bs.set(0);\n\
    \    std::vector<std::vector<int>> t2add(1, {0});\n\n    for (int a : A) {\n \
    \       auto diff = (bs << a) & ~bs;\n        t2add.push_back({});\n        for\
    \ (int j = diff.first(); j <= K; j = diff.next(j)) {\n            bs.set(j);\n\
    \            t2add.back().push_back(j);\n        }\n    }\n    return t2add;\n\
    }\n\nint main() {\n    cin.tie(nullptr), ios::sync_with_stdio(false);\n\n    int\
    \ N, K;\n    cin >> N >> K;\n    vector<int> A(N);\n    for (auto &x : A) cin\
    \ >> x;\n\n    auto t2add = knapsack_first_fit(A, K);\n\n    dynamic_bitset left(K\
    ...
    \        }\n        cout << ret << '\\n';\n    }\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1861\"\n#include \"../dynamic_bitset.hpp\"\
    \n#include <iostream>\n#include <vector>\nusing namespace std;\n\nstd::vector<std::vector<int>>\
    \ knapsack_first_fit(const std::vector<int> &A, int K) {\n    dynamic_bitset bs(K\
    \ + 1);\n\n    bs.set(0);\n    std::vector<std::vector<int>> t2add(1, {0});\n\n\
    \    for (int a : A) {\n        auto diff = (bs << a) & ~bs;\n        t2add.push_back({});\n\
  ...
  verifiedWith: []
documentation_of: data_structure/test/dynamic_bitset.yuki1861.test.cpp
layout: document
redirect_from:
- /verify/data_structure/test/dynamic_bitset.yuki1861.test.cpp
- /verify/data_structure/test/dynamic_bitset.yuki1861.test.cpp.html
