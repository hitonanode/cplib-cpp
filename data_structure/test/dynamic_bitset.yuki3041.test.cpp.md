...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/3041
    links:
    - https://yukicoder.me/problems/no/3041
  bundledCode: "#line 1 \"data_structure/test/dynamic_bitset.yuki3041.test.cpp\"\n\
    ...
    \        }\n        return -1;\n    }\n};\n#line 4 \"data_structure/test/dynamic_bitset.yuki3041.test.cpp\"\
    \n#include <iostream>\n#line 6 \"data_structure/test/dynamic_bitset.yuki3041.test.cpp\"\
    ...
    \ > b) swap(a, b);\n        b -= a;\n        c -= a;\n        bs = bs | (bs <<\
    \ b) | (bs << c);\n        cout << bs.count() << '\\n';\n    }\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/3041\"\n#include \"../dynamic_bitset.hpp\"\
    \n#include <algorithm>\n#include <iostream>\n#include <vector>\nusing namespace\
    \ std;\n\nint main() {\n    cin.tie(nullptr), ios::sync_with_stdio(false);\n\n\
    \    int N, F;\n    cin >> N >> F;\n    vector<int> A(N), B(N), C(N);\n    for\
    \ (auto &a : A) cin >> a;\n    for (auto &b : B) cin >> b;\n    for (auto &c :\
  ...
  verifiedWith: []
documentation_of: data_structure/test/dynamic_bitset.yuki3041.test.cpp
layout: document
redirect_from:
- /verify/data_structure/test/dynamic_bitset.yuki3041.test.cpp
- /verify/data_structure/test/dynamic_bitset.yuki3041.test.cpp.html
