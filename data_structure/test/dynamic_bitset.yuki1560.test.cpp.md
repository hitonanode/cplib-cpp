...
data:
  ...
  bundledCode: "#line 1 \"data_structure/test/dynamic_bitset.yuki1560.test.cpp\"\n\
    ...
    \ (f >= a) dp[s | (1 << j)] += dp[s];\n            }\n    }\n    cout << dp.back()\
    \ << '\\n';\n}\n"
  code: "#define PROBLEM \"https://yukicoder.me/problems/no/1560\"\n#include \"../dynamic_bitset.hpp\"\
    \n#include <bit>\n#include <iostream>\n#include <vector>\nusing namespace std;\n\
    \nint main() {\n    cin.tie(nullptr), ios::sync_with_stdio(false);\n\n    int\
    \ N, M;\n    cin >> N >> M;\n    vector S(N, vector<int>(M));\n    for (auto &row\
    \ : S)\n        for (auto &x : row) cin >> x;\n\n    vector bs(M, dynamic_bitset(N));\n\
  ...
  verifiedWith: []
documentation_of: data_structure/test/dynamic_bitset.yuki1560.test.cpp
layout: document
redirect_from:
- /verify/data_structure/test/dynamic_bitset.yuki1560.test.cpp
- /verify/data_structure/test/dynamic_bitset.yuki1560.test.cpp.html
