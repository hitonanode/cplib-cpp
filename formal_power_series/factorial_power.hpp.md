...
data:
  ...
  bundledCode: "#line 2 \"modint.hpp\"\n#include <iostream>\n#include <set>\n#include\
    ...
    \ y = f(x) is poly of up to (N - 1)-th\n// degree Complexity: O(N log N)\ntemplate\
    \ <class T> std::vector<T> shift_of_sampling_points(const std::vector<T> ys, T\
  ...
  code: "#pragma once\n#include \"../convolution/ntt.hpp\"\n#include <algorithm>\n\
    ...
    \ 1] from y[0], ..., y[N - 1] where y = f(x) is poly of up to (N - 1)-th\n// degree\
    \ Complexity: O(N log N)\ntemplate <class T> std::vector<T> shift_of_sampling_points(const\
