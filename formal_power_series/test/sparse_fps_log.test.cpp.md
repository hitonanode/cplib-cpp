...
data:
  ...
  bundledCode: "#line 1 \"formal_power_series/test/sparse_fps_log.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/log_of_formal_power_series_sparse\"\
    ...
    // using mint = ModInt<1000000007>;\n#line 6 \"formal_power_series/test/sparse_fps_log.test.cpp\"\
    \nusing namespace std;\nusing mint = ModInt<998244353>;\n\nint main() {\n    cin.tie(nullptr),\
    \ ios::sync_with_stdio(false);\n    int N, K;\n    cin >> N >> K;\n    vector<mint>\
    \ f(N);\n    while (K--) {\n        int i, a;\n        cin >> i >> a;\n      \
    \  f.at(i) = a;\n    }\n\n    const auto ret = sparse_fps::log(f, N - 1);\n\n\
  ...
  verifiedWith: []
documentation_of: formal_power_series/test/sparse_fps_log.test.cpp
layout: document
redirect_from:
- /verify/formal_power_series/test/sparse_fps_log.test.cpp
- /verify/formal_power_series/test/sparse_fps_log.test.cpp.html
