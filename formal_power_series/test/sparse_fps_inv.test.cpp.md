...
data:
  ...
  bundledCode: "#line 1 \"formal_power_series/test/sparse_fps_inv.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/inv_of_formal_power_series_sparse\"\
    ...
    // using mint = ModInt<1000000007>;\n#line 6 \"formal_power_series/test/sparse_fps_inv.test.cpp\"\
    \nusing namespace std;\nusing mint = ModInt<998244353>;\n\nint main() {\n    cin.tie(nullptr),\
  ...
  verifiedWith: []
documentation_of: formal_power_series/test/sparse_fps_inv.test.cpp
layout: document
redirect_from:
- /verify/formal_power_series/test/sparse_fps_inv.test.cpp
- /verify/formal_power_series/test/sparse_fps_inv.test.cpp.html
