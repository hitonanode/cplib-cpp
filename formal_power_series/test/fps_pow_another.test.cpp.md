...
data:
  ...
  bundledCode: "#line 1 \"formal_power_series/test/fps_pow_another.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/pow_of_formal_power_series\"\n#include\
    \ <iostream>\n#line 3 \"modint.hpp\"\n#include <vector>\n#include <set>\n\n//\
    ...
    \      return ret;\n    }\n};\n#line 5 \"formal_power_series/test/fps_pow_another.test.cpp\"\
...
layout: document
redirect_from:
- /verify/formal_power_series/test/fps_pow_another.test.cpp
- /verify/formal_power_series/test/fps_pow_another.test.cpp.html
