...
data:
  ...
  bundledCode: "#line 1 \"formal_power_series/test/sparse_fps_pow.yuki1939.test.cpp\"\
    ...
    // using mint = ModInt<1000000007>;\n#line 6 \"formal_power_series/test/sparse_fps_pow.yuki1939.test.cpp\"\
    \nusing namespace std;\nusing mint = ModInt<998244353>;\n\nint main() {\n    cin.tie(nullptr),\
    \ ios::sync_with_stdio(false);\n    int N, M;\n    cin >> N >> M;\n    vector<mint>\
    \ f(N + 1);\n    f[0] = 1;\n    while (M--) {\n        int l;\n        cin >>\
    \ l;\n        f[l] += 1;\n    }\n    cout << sparse_fps::pow(f, N, N + 1)[N] /\
    \ (N + 1) << '\\n';\n}\n"
  ...
  verifiedWith: []
documentation_of: formal_power_series/test/sparse_fps_pow.yuki1939.test.cpp
layout: document
redirect_from:
- /verify/formal_power_series/test/sparse_fps_pow.yuki1939.test.cpp
- /verify/formal_power_series/test/sparse_fps_pow.yuki1939.test.cpp.html
