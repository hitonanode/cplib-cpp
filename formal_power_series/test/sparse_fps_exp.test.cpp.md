...
data:
  ...
  bundledCode: "#line 1 \"formal_power_series/test/sparse_fps_exp.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.yosupo.jp/problem/exp_of_formal_power_series_sparse\"\
  ...
  verifiedWith: []
documentation_of: formal_power_series/test/sparse_fps_exp.test.cpp
layout: document
redirect_from:
- /verify/formal_power_series/test/sparse_fps_exp.test.cpp
- /verify/formal_power_series/test/sparse_fps_exp.test.cpp.html
