...
data:
  ...
  bundledCode: "#line 1 \"set_power_series/test/subset_exp.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/exp_of_set_power_series\"\n#line 2 \"modint.hpp\"\
    \n#include <cassert>\n#include <iostream>\n#include <set>\n#include <vector>\n\
    ...
    \ poly_pow);\n}\n#line 5 \"set_power_series/test/subset_exp.test.cpp\"\nusing\
    \ namespace std;\nusing mint = ModInt<998244353>;\n\nint main() {\n    cin.tie(nullptr);\n\
    \    ios::sync_with_stdio(false);\n\n    int N;\n    cin >> N;\n    vector<mint>\
    \ f(1 << N);\n    for (auto &x : f) cin >> x;\n    subset_exp(f);\n    for (int\
    \ i = 0; i < 1 << N; i++) cout << f.at(i) << \" \\n\"[i + 1 == 1 << N];\n}\n"
  ...
  requiredBy: []
  timestamp: '2024-10-20 20:08:25+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: set_power_series/test/subset_exp.test.cpp
layout: document
redirect_from:
- /verify/set_power_series/test/subset_exp.test.cpp
- /verify/set_power_series/test/subset_exp.test.cpp.html
