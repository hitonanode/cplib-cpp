...
data:
  ...
  bundledCode: "#line 2 \"string/lyndon_factorization.hpp\"\n#include <algorithm>\n\
    ...
    \ S. Zhang, and W. H. Chan,\n// Two Efficient Algorithms for Linear Time Suffix\
    \ Array Construction\ntemplate <int THRESHOLD_NAIVE = 10, int THRESHOLD_DOUBLING\
    \ = 40> std::vector<int> sa_is(const std::vector<int>& s, int upper) {\n    int\
    \ n = int(s.size());\n    if (n == 0) return {};\n    if (n == 1) return {0};\n\
    \    if (n == 2) {\n        if (s[0] < s[1]) {\n            return {0, 1};\n \
    ...
    \ 3 \"string/test/run_enumerate_lyndon_rmq.test.cpp\"\n#include <iostream>\n#line\
    \ 5 \"string/test/run_enumerate_lyndon_rmq.test.cpp\"\n#define PROBLEM \"https://judge.yosupo.jp/problem/runenumerate\"\
