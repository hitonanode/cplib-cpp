...
data:
  ...
  bundledCode: "#line 2 \"string/suffix_array.hpp\"\n#include <algorithm>\n#include\
    ...
    \ // if you need occurence positions\n}\n#line 2 \"string/test/sa_count_keyword.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: string/test/sa_count_keyword.test.cpp
layout: document
redirect_from:
- /verify/string/test/sa_count_keyword.test.cpp
- /verify/string/test/sa_count_keyword.test.cpp.html
