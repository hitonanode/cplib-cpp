...
data:
  ...
  bundledCode: "#line 1 \"flow/test/submodular_opt.yuki2320.test.cpp\"\n#define PROBLEM\
    ...
    \ total_cost, sol};\n    }\n};\n#line 4 \"flow/test/submodular_opt.yuki2320.test.cpp\"\
    \n\n#include <iostream>\nusing namespace std;\n\nint main() {\n    int N, S, T;\n\
  ...
  verifiedWith: []
documentation_of: flow/test/submodular_opt.yuki2320.test.cpp
layout: document
redirect_from:
- /verify/flow/test/submodular_opt.yuki2320.test.cpp
- /verify/flow/test/submodular_opt.yuki2320.test.cpp.html
