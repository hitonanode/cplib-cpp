...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2943
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2943
  bundledCode: "#line 1 \"flow/test/submodular_opt.aoj2943.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2943\"\n// Bipartite\
    ...
    \ total_cost, sol};\n    }\n};\n#line 4 \"flow/test/submodular_opt.aoj2943.test.cpp\"\
    \n\n#include <iostream>\n#include <string>\n#line 8 \"flow/test/submodular_opt.aoj2943.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n    int h, w, W;\n    cin >> h >> w >>\
    \ W;\n    vector B(h, vector<int>(w));\n    for (auto &row : B) {\n        for\
    \ (auto &b : row) cin >> b;\n    }\n\n    auto isin = [&](int i, int j) { return\
    \ 0 <= i and i < h and 0 <= j and j < w; };\n\n    SubmodularOptimizationViaGraphCut<pair<int,\
    \ int>> so;\n\n    for (int i = 0; i + 1 < h; ++i) {\n        for (int j = 0;\
    \ j + 1 < w; ++j) {\n            if ((i + j) % 2) continue;\n\n            auto\
    \ f = W - ((long long)B.at(i).at(j) + B.at(i + 1).at(j) + B.at(i).at(j + 1) +\n\
    \                          B.at(i + 1).at(j + 1));\n\n            so.Impose({i,\
    \ j}, true, f);\n\n            for (int dx : {1}) {\n                for (int\
    ...
    \    cout << -res.total_cost << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2943\"\
    \n// Bipartite graph, flipping is important\n#include \"../submodular_optimization_via_graph_cut.hpp\"\
    \n\n#include <iostream>\n#include <string>\n#include <utility>\nusing namespace\
    \ std;\n\nint main() {\n    int h, w, W;\n    cin >> h >> w >> W;\n    vector\
    \ B(h, vector<int>(w));\n    for (auto &row : B) {\n        for (auto &b : row)\
    \ cin >> b;\n    }\n\n    auto isin = [&](int i, int j) { return 0 <= i and i\
    \ < h and 0 <= j and j < w; };\n\n    SubmodularOptimizationViaGraphCut<pair<int,\
    \ int>> so;\n\n    for (int i = 0; i + 1 < h; ++i) {\n        for (int j = 0;\
    \ j + 1 < w; ++j) {\n            if ((i + j) % 2) continue;\n\n            auto\
    \ f = W - ((long long)B.at(i).at(j) + B.at(i + 1).at(j) + B.at(i).at(j + 1) +\n\
  ...
  verifiedWith: []
documentation_of: flow/test/submodular_opt.aoj2943.test.cpp
layout: document
redirect_from:
- /verify/flow/test/submodular_opt.aoj2943.test.cpp
- /verify/flow/test/submodular_opt.aoj2943.test.cpp.html
