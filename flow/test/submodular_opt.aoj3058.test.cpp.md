...
data:
  ...
  attributes:
    ...
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3058
  bundledCode: "#line 1 \"flow/test/submodular_opt.aoj3058.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3058\"\n\n#line\
    \ 2 \"flow/submodular_optimization_via_graph_cut.hpp\"\n#include <algorithm>\n\
    #include <array>\n#include <cassert>\n#include <map>\n#include <tuple>\n#include\
    \ <utility>\n#include <vector>\n\n#include <atcoder/maxflow>\n\ntemplate <class\
    \ VarName = int, class Cost = long long> class SubmodularOptimizationViaGraphCut\
    ...
    \ auto res = so.Solve();\n\n    cout << res.total_cost << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=3058\"\
  ...
  verifiedWith: []
documentation_of: flow/test/submodular_opt.aoj3058.test.cpp
layout: document
redirect_from:
- /verify/flow/test/submodular_opt.aoj3058.test.cpp
- /verify/flow/test/submodular_opt.aoj3058.test.cpp.html
