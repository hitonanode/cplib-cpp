...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2903
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2903
  bundledCode: "#line 1 \"flow/test/submodular_opt.aoj2903.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2903\"\n// Bipartite\
    \ graph, flipping is important\n#line 2 \"flow/submodular_optimization_via_graph_cut.hpp\"\
    \n#include <algorithm>\n#include <array>\n#include <cassert>\n#include <map>\n\
    ...
    \ total_cost, sol};\n    }\n};\n#line 4 \"flow/test/submodular_opt.aoj2903.test.cpp\"\
    \n\n#include <iostream>\n#include <string>\n#line 8 \"flow/test/submodular_opt.aoj2903.test.cpp\"\
    \nusing namespace std;\n\nint main() {\n    int R, C;\n    cin >> R >> C;\n  \
    \  vector<string> grid(R);\n    for (auto &row : grid) cin >> row;\n\n    auto\
    \ isin = [&](int i, int j) {\n        return 0 <= i and i < R and 0 <= j and j\
    \ < C and grid.at(i).at(j) == '#';\n    };\n    const vector<pair<int, int>> dxdys{{-1,\
    \ 0}, {1, 0}, {0, -1}, {0, 1}};\n\n    using Point = pair<int, int>;\n    using\
    \ Edge = pair<Point, Point>;\n    SubmodularOptimizationViaGraphCut<Edge> so;\n\
    \n    for (int i = 0; i < R; ++i) {\n        for (int j = 0; j < C; ++j) {\n \
    ...
    \            for (auto e1 : edges.at(0)) {\n                for (auto e2 : edges.at(1))\
    \ { so.Impose(e1, true, e2, true, 1 << 20); }\n            }\n        }\n    }\n\
    \n    const auto res = so.Solve();\n    cout << res.total_cost << '\\n';\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2903\"\
    ...
    \ == '#';\n    };\n    const vector<pair<int, int>> dxdys{{-1, 0}, {1, 0}, {0,\
    \ -1}, {0, 1}};\n\n    using Point = pair<int, int>;\n    using Edge = pair<Point,\
    \ Point>;\n    SubmodularOptimizationViaGraphCut<Edge> so;\n\n    for (int i =\
    \ 0; i < R; ++i) {\n        for (int j = 0; j < C; ++j) {\n            if (!isin(i,\
    \ j)) continue;\n\n            so.Impose(1);\n\n            vector<vector<Edge>>\
    \ edges(2);\n            for (auto [dx, dy] : dxdys) {\n                const\
    ...
    \                   swap(e.first, e.second);\n                }\n            \
    \    edges[dx != 0].push_back(e);\n            }\n\n            for (auto e1 :\
    \ edges.at(0)) {\n                for (auto e2 : edges.at(1)) { so.Impose(e1,\
    \ true, e2, true, 1 << 20); }\n            }\n        }\n    }\n\n    const auto\
    \ res = so.Solve();\n    cout << res.total_cost << '\\n';\n}\n"
  dependsOn:
  ...
  verifiedWith: []
documentation_of: flow/test/submodular_opt.aoj2903.test.cpp
layout: document
redirect_from:
- /verify/flow/test/submodular_opt.aoj2903.test.cpp
- /verify/flow/test/submodular_opt.aoj2903.test.cpp.html
