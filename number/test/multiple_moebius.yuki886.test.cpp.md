...
data:
  ...
  bundledCode: "#line 1 \"number/test/multiple_moebius.yuki886.test.cpp\"\n#define\
    \ PROBLEM \"https://yukicoder.me/problems/no/886\"\n\n#line 2 \"modint.hpp\"\n\
    #include <cassert>\n#include <iostream>\n#include <set>\n#include <vector>\n\n\
    ...
    \ 7 \"number/test/multiple_moebius.yuki886.test.cpp\"\nusing namespace std;\n\n\
    using mint = ModInt<1000000007>;\n\nint main() {\n    int H, W;\n    cin >> H\
    \ >> W;\n    int N = max(H, W);\n    vector<mint> dp(N);\n\n    auto calc = [&](int\
    \ n, int W) -> mint {\n        // 2 * ((W - n) + (W - 2 * n) + ...)\n        mint\
  ...
  verifiedWith: []
documentation_of: number/test/multiple_moebius.yuki886.test.cpp
layout: document
redirect_from:
- /verify/number/test/multiple_moebius.yuki886.test.cpp
- /verify/number/test/multiple_moebius.yuki886.test.cpp.html
